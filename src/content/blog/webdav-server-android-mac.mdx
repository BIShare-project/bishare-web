...
![An Android phone running a WebDAV server on the local network, mounted as a volume in the Mac Finder without any cloud account](/blog/diagram-webdav-mount.svg)
