...
![Six points of exposure for a confidential document: the network, the server, the link, the endpoint device, the recipient, and everyday habit](/blog/diagram-six-adversaries.svg)
