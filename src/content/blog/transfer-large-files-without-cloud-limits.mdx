...
![Moving one gigabyte takes about five minutes through the cloud, most of it spent uploading, versus roughly 25 seconds for a single hop across local Wi-Fi](/blog/diagram-where-time-goes.svg)
...
- **The 86 GB archive handoff** — [laptop to laptop](/transfer-files-between-computers) before a colleague's last day. No plan upgrade, no overnight upload, no link to babysit. Router speed for as long as it takes; both machines on power; done before lunch.
