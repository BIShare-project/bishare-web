...
**Install a local transfer app on both devices before you need it.** [BIShare](/download) is free and runs on iPhone, Android, Mac, Windows and Linux; the person receiving can also just [open a browser tab](/transfer) on the same network if they'd rather not install anything. The trap is installing it alone, then discovering at the moment of need that the other side doesn't have it.
