 ...
 * the "photosIphonePc" namespace; FAQPage JSON-LD for long-tail snippets.
 */
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "photosIphonePc" });
  const title = t("meta.title");
  const description = t("meta.description");
  return {
    title: { absolute: title },
    description,
    alternates: buildAlternates(locale, "/transfer-photos-from-iphone-to-pc"),
    ...sharedOpenGraph(title, description, "/transfer-photos-from-iphone-to-pc"),
  };
}

/* Columns: USB + Photos app · iCloud · BIShare (labels via comparison.cols). */
const COMPARISON: Array<{
  ...
  { id: "r0", airdrop: false, quick: true, bishare: true },
  { id: "r1", airdrop: true, quick: false, bishare: true },
  { id: "r2", airdrop: true, quick: false, bishare: true },
  { id: "r3", airdrop: true, quick: false, bishare: true },
  { id: "r4", airdrop: true, quick: false, bishare: true },
];
...
export default async function TransferPhotosIphoneToPcPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("photosIphonePc");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 md:py-24">
        ...
        <RelatedLinks current="/transfer-photos-from-iphone-to-pc" />
      </main>
