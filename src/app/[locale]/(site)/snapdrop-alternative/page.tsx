 ...
 * all 13 locales via the "snapdropAlt" namespace, with FAQPage structured
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "snapdropAlt" });
  const title = t("meta.title");
  const description = t("meta.description");
  return {
    title: { absolute: title },
    description,
    alternates: buildAlternates(locale, "/snapdrop-alternative"),
    ...sharedOpenGraph(title, description, "/snapdrop-alternative"),
  };
}
...
export default async function SnapdropAlternativePage({
  ...
  const t = await getTranslations("snapdropAlt");
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 md:py-24">
        ...
        <RelatedLinks current="/snapdrop-alternative" />
      </main>
