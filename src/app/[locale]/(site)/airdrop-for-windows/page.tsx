 ...
 * all 13 locales via the "airdropWindows" namespace, with FAQPage structured
...
const COMPARISON: Array<{
  ...
  { id: "iphoneWindows", airdrop: false, quick: false, bishare: true },
  { id: "macWindows", airdrop: false, quick: false, bishare: true },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(breadcrumbLd("/airdrop-for-windows", "AirDrop for Windows")).replace(/</g, "\\u003c"),
        }}
      />
      <SiteHeader />
